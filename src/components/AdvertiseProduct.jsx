        ...
        <section className='sec_pad bg-[#F1F0FF]'>
            <Container>
                <div className="flex gap-x-5">
                    <div className="">
                        <Image src={Adver} alt='latest_product'/>
                    </div>
                    <div className="pt-[80px] w-[40%]">
                        <h2 className='text-[35px] font-bold text-[#151875] pb-[25px]'>Unique Features Of leatest & Trending Poducts</h2>
                        <ul>
                        ...
                        <div className="flex gap-x-4">
                            <div className="">
                                <button className='text-[17px] font-medium text-[#FFF] px-[35px] py-[10px] bg-[#FB2E86]'>Add To Cart</button>
                            </div>
                            <div className="">
                                <h5 className='text-[17px] font-medium text-[#151875]'>B&B Italian Sofa</h5>
